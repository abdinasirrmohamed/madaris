...
class AccessControlSeeder extends Seeder
{
    ...
    {
        $keys = ['students.view', 'students.create', 'students.update', 'students.promote', 'attendance.take', 'attendance.correct', 'academic.manage', 'quran.manage', 'finance.manage', 'accounts.manage', 'examinations.manage', 'hrm.manage', 'sms.configure', 'sms.send', 'reports.view', 'feedback.manage', 'users.manage', 'roles.manage', 'audit.view', 'settings.manage'];
        $permissions = [];
        foreach ($keys as $key) {
        ...
        foreach (DB::table('Tenants')->pluck('TenantId') as $tenantId) {
            $definitions = ['Tenant Owner' => $keys, 'School Administrator' => $keys, 'Registrar' => ['students.view', 'students.create', 'students.update', 'students.promote', 'academic.manage', 'reports.view'], 'Teacher' => ['students.view', 'attendance.take', 'quran.manage', 'examinations.manage'], 'Attendance Officer' => ['students.view', 'attendance.take', 'attendance.correct', 'reports.view'], 'Finance Officer' => ['students.view', 'finance.manage', 'accounts.manage', 'reports.view'], 'HR Officer' => ['hrm.manage', 'reports.view'], 'Examiner' => ['students.view', 'examinations.manage', 'reports.view'], 'Report Viewer' => ['students.view', 'reports.view']];
