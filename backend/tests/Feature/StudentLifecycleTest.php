...
class StudentLifecycleTest extends TestCase
{
 ...
 public function test_guardian_enrollment_capacity_and_promotion_history():void
 {
  ...
  $second=$this->postJson('/api/v1/students',['BranchId'=>$branch,'AdmissionNo'=>'ADM-2','FirstName'=>'Hodan','LastName'=>'Nur','Gender'=>'Female','AdmissionDate'=>'2026-01-01','WelfareStatus'=>'Normal','Status'=>'Active'])->assertCreated()->json('data');
  $this->postJson("/api/v1/students/{$second['StudentId']}/guardians",['FullName'=>'Amina Nur','PrimaryPhone'=>'610000000','IsPrimary'=>true,'IsFeeResponsible'=>true])->assertCreated();
  $this->assertDatabaseCount('Guardians',1);$this->assertDatabaseCount('StudentGuardians',2);
