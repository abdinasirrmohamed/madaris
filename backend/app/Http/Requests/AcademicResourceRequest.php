...
class AcademicResourceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match ($this->route('resource')) {
            ...
            'levels' => ['Name' => ['required', 'string', 'max:80'], 'Code' => ['required', 'string', 'max:20'], 'SequenceNo' => ['required', 'integer', 'min:1'], 'MinimumPromotionScore' => ['required', 'numeric', 'between:0,100'], 'Status' => ['required', Rule::in(['Active', 'Inactive'])]],
